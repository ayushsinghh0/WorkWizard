...
import { createCompany, createJob, deleteCompany, getAllActiveJobs, getAllApplicationForJob, getAllCompany, getCompanyDetails, getSingleJob, updateApplication, updatedJob } from "../controllers/job.js";
...
router.put("/:jobId",isAuth,updatedJob);
