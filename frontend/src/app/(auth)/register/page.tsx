...
const RegisterPage = () =>{
    ...
    return  <div className="min-h-screen flex items-center justify-center px-4 py-12" > 
                <div className="w-full max-w-md">
                    ...
                    <h1 className="text-4xl font-bold mb-2">Join to Work Wizard</h1>
                        ...
                        <form onSubmit ={submitHandler} className="space-y-5">
                           <div className="space-y-2">
                                ...
                                <div className="relative">
                                   ...
                                   <select id="role" value ={role} onChange={(e)=>setRole(e.target.value) } className="w-full h-11 pl-10 pr-4 border-2 border-gray-300 rounded-md bg-transparent" required>
...

                            {
                                ...
                                <div className="relative">
                                    ...
                                    <Input id="name" type="text" placeholder="Ayush Raj" value={name} onChange={e=>setName(e.target.value)} required className="pl-10 h-11"/>
                                </div>
                                 </div>
                                    <div className="space-y-2">
                            ...
                            </div>
                            {
                              ...
                              <Button disabled ={btnLoading} className="w-full">{btnLoading?"Please Wait..":"Register"}
