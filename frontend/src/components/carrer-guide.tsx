    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-lg opacity-70 max-w-2xl mx-auto mb-8">
          Get personalized job recommendations and learnings roadmap based on
          your skills
        </p>
            ...
            {!response ? (
              <>
                ...
                <div className="space-y-4 py-4">
                  ...
                  {skills.length > 0 && (
                    <div className="space-y-2">
                      <Label>Your Skill ({skills.length})</Label>
              ...
              <>
                ...
                <div className="space-y-6 py-7">
                                ...
                                response?.skillsToLearn?.map((category,index)=>(
                                   <div className="space-y-2" key={index}>
                                     <h4  className="font-semibold text-sm text-blue-600">{category.category}</h4>
                                      ...
                                      <div className="space-y-2">{category?.skills?.map((skill,sindex)=>(
                    ...
                    <h3 className="text-lg font font-semibold mb-3 flex items-center gap-2">
